...
"curso-sabado": {
  ...
  content: `
    ...
    Inicio: sábado 21 de febrero<br>
    Término: sábado 16 de mayo<br>
    Asueto: sábado 4 de abril</p>

    <p><strong>Idioma, nivel y horario</strong></p>
    <h4>Inglés</h4>
    <ul>
      <li><strong>A2:</strong> 7:00–12:30 h</li>
    </ul>

    <p><strong>Cuotas de recuperación:</strong></p>
    <ul>
      <li>Inscripción: <strong>$100</strong></li>
      <li>Colegiatura: <strong>$1,500</strong></li>
    ...
    <p><strong>Inscripciones:</strong><br>
    <strong>Exclusivamente del 16 al 20 de febrero.</strong><br>
    Cupo limitado: mínimo <strong>15</strong>, máximo <strong>25</strong> participantes.</p>
    ...
    <p><strong>Otros idiomas:</strong><br>
    Para horarios o niveles distintos, o para cursos de otras lenguas, regístrate en la sección: <strong>Lista de Espera</strong>.</p>

    <p><strong>Importante:</strong><br>
    El curso está diseñado para un avance equilibrado entre habilidades y competencias de acuerdo a los lineamientos del MCER.
    Lo recomendamos para participantes con alto nivel de compromiso.</p>
...
"curso-sabsabdomado": {
  ...
  content: `
    ...
    <ul>
      <li><strong>Nivel 1:</strong> 7:00–10:00 h</li>
    </ul>

    <p><strong>Calendario:</strong><br>
    Inicio: sábado 14 de febrero<br>
    Término: domingo 26 de marzo<br>
    Asuetos: sábado 4 y domingo 5 de abril</p>
    ...
    <p><strong>Inglés</strong></p>
    <ul>
      <li><strong>Nivel 1:</strong> 10:00–13:00 h</li>
      <li><strong>B1:</strong> 10:00–13:00 h</li>
      <li><strong>B1:</strong> 19:00–22:00 h</li>
    </ul>

    <p><strong>Alemán</strong></p>
    <ul>
      <li><strong>Nivel 1:</strong> 19:00–22:00 h</li>
    </ul>
 ...
 "curso-lumievie": {
  ...
  content: `
    ...
    <p><strong>Calendario:</strong><br>
    Inicio: lunes 16 de febrero<br>
    Término: lunes 6 de mayo<br>
    Asuetos: 16, 30 y 31 de marzo; 1, 2 y 3 de abril; y 1 de mayo</p>
    ...
    <p><strong>Inglés</strong></p>
    <ul>
      <li><strong>B1:</strong> 7:00–9:00</li>
      <li><strong>B2:</strong> 19:00–21:00</li>
    </ul>

    <p><strong>Calendario:</strong><br>
    Inicio: miércoles 23 de febrero<br>
    Término: lunes 13 de mayo<br>
    Asuetos: 16, 30 y 31 de marzo; 1, 2 y 3 de abril; y 1 de mayo</p>
...
"curso-luavie75": {
  ...
  content: `
    ...
    <p><strong>Inglés</strong></p>
    <ul>
      <li><strong>Nivel 1:</strong> 19:00 – 20:30</li>
      <li><strong>A2:</strong> 7:00 – 8:30</li>
    </ul>

    <p><strong>Calendario:</strong><br>
    Inicio: lunes 23 de febrero<br>
    Término: lunes 27 de abril<br>
    Asuetos: 16, 30 y 31 de marzo; 1, 2 y 3 de abril</p>
  ...
  "curso-sabsabdomado": {
    idiomas: {
      ingles: {
        ...
        B1: [{ dias: ["Sáb", "Dom"], horas: ["10:00-13:00", "19:00-22:00"] }],
      },
      /*frances: {
  ...
  "curso-lumievie": {
    idiomas: {
      ingles: {
        ...
        A2: [{ dias: ["Lun", "Mié", "Vie"], horas: ["18:00-20:00"] }],
        B1: [{ dias: ["Lun", "Mié", "Vie"], horas: ["07:00-09:00", "19:00-21:00"] }],
        B2: [{ dias: ["Lun", "Mié", "Vie"], horas: ["19:00-21:00"] }],
      },/*
      frances: {
